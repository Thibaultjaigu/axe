...
func New(providerName, apiKey, baseURL string) (Provider, error) {
	...
	default:
		return nil, fmt.Errorf("unsupported provider %q: supported providers are anthropic, atlascloud, openai, ollama, opencode, google, minimax, bedrock, openrouter, requesty", providerName)
	}
}
